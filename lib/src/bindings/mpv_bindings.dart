...
/// Auto-generated, internal bindings to libmpv
class MpvBindings {
  ...
  MpvBindings(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  MpvBindings.fromLookup(
...
class mpv_stream_cb_info extends ffi.Struct {
  ...
  external mpv_stream_cb_read_fn read_fn;
...
/// @return 0 on EOF
/// @return -1 on error
typedef mpv_stream_cb_read_fn = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Int64 Function(
            ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Char>, ffi.Uint64)>>;
...
typedef mpv_stream_cb_seek_fn = ffi.Pointer<
    ffi.NativeFunction<ffi.Int64 Function(ffi.Pointer<ffi.Void>, ffi.Int64)>>;
...
typedef mpv_stream_cb_size_fn = ffi
...
const int MPV_CLIENT_API_VERSION = 131072;
